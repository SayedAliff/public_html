        ...
        <header>
          <nav className="navbar">
            <Link to="/" className="logo">
              {/* Responsive, CDN-ready, compressed logo image */}
              <img
                src="https://cdn.example.com/images/Meta.webp"
                srcSet="https://cdn.example.com/images/Meta-small.webp 480w, https://cdn.example.com/images/Meta-medium.webp 800w, https://cdn.example.com/images/Meta-large.webp 1200w"
                sizes="(max-width: 600px) 480px, (max-width: 900px) 800px, 1200px"
                alt="Qubit Cloud Logo"
                height="50"
